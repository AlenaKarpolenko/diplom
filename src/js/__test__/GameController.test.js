...
test('Проверка наличия персонажа в команде. Если есть- замена курсора', () => {
...
test('Проверка возможности перемещения в ячейку', () => {
...
test('Проверка возможности перемещения в ячейку. Если это невозможно- замена курсора', () => {
  // eslint-disable-next-line prefer-destructuring
  gameControl.personIndex = 0;
